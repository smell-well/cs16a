...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    x_a, y_a = get_lat(city_a), get_lon(city_a)
    x_b, y_b = get_lat(city_b), get_lon(city_b)
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    t = make_city('mid', lat, lon)
    d1 = distance(t, city_a)
    d2 = distance(t, city_b)
